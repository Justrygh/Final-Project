...
class DNSDatabase:
    ...
    def insert_har(self, experiment, domain, browser, recursive, operation_sys, dns_type, har, har_uuid, har_error, delays):
        insert = ''' INSERT INTO {}
                     (uuid, experiment, insertion_time, domain, browser, recursive, operation_sys, dns_type, har, error, delays)
        ...
        if har:
            tup = (har_uuid, experiment, now, domain, browser, recursive, operation_sys,
    ...
    def insert_dns(self, har_uuid, experiment, browser, recursive, operation_sys,
                   dns_type, all_dns_info):
        insert = '''INSERT INTO {}
                    (har_uuid, experiment,
                     insertion_time, domain,
                     browser, recursive, operation_sys,
                     dns_type, response_size, response_time,
                     error)
                    VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
                 '''.format(self.dns_table)
        ...
        for domain in all_dns_info:
            ...
            tup = (har_uuid, experiment, now,
                   domain, browser, recursive, operation_sys,
                   dns_type, response_size, response_time,
                   error)
